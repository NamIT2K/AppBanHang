...
public class ResetMatKhauActivity extends AppCompatActivity {
    EditText email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reset_mat_khau);
        initView();
        initControll();
    }
        ...
        btnreset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(str_email)){
                    ...
                    compositeDisposable.add(apiBanHang.resetMatKhau(str_email)
    ...
    private void initView() {
        ...
        email = findViewById(R.id.edtresetmatkhau);
        btnreset = findViewById(R.id.btnresetmatkhau);
